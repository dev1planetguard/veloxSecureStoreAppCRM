          ...
          <CardContent style={styles.cardContent}>
            ...
            <View style={styles.actionRow}>
              <TouchableOpacity onPress={() => onCallCustomer(item)} style={styles.iconBtn}>
                <FeatherIcon name="phone" size={wp('3.7%')} color="#fff" />
              </TouchableOpacity>
              <TouchableOpacity onPress={() => openEdit(item)} style={[styles.iconBtn, { backgroundColor: '#d97706' }]}>
                <FeatherIcon name="edit-2" size={wp('3.7%')} color="#fff" />
              </TouchableOpacity>
              <TouchableOpacity onPress={() => handleDelete(item)} style={[styles.iconBtn, { backgroundColor: '#dc2626' }]}>
                <FeatherIcon name="trash-2" size={wp('3.7%')} color="#fff" />
              </TouchableOpacity>
               <TouchableOpacity onPress={() => setPayment(!payment)} style={[styles.iconBtn, { backgroundColor: 'green' }]}>
                <Text style={{color:'white',fontSize:wp('4%')}}>₹</Text>
              </TouchableOpacity>
            </View>
          </CardContent>
        </Card>
...
const styles = StyleSheet.create({
  ...
  card: { backgroundColor: '#1e293b', padding: wp('3%'),borderColor:'#1e293b',elevation:10 },
  ...
  iconBtn: { marginLeft: wp('3%'), backgroundColor: '#2563eb', padding: wp('2%'), borderRadius: wp('2%'),width:wp(10),alignItems:'center',justifyContent:'center' },
});
