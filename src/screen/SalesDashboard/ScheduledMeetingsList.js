    ...
    React.useCallback(() => {
      ...
      (async () => {
        try {
          ...
          const res = await fetch(`http://192.168.0.204:9191/api/v1`,
            {
      ...
      <View style={styles.header}>
        ...
        > */}
         <TouchableOpacity
          ...
          style={styles.menuBtn}
       >
          <Feather name="menu-outline" size={24} color="#fff" />
        </TouchableOpacity>
...
{mt.scheduledTime === 'Pending Schedule' ? (
  ...
  >
                  <Feather name="calendar-outline" size={18} color="#fff" />
                ...
                <TouchableOpacity
                  ...
                  onPress={() =>
                    ...
                    navigation.navigate('FetchLocationScreen', {
                      meetingId,
                      customerId,
                      latitude,
                      longitude,
      ...
      >
        <View style={styles.modalBg}>
          <View style={styles.modalContent}>
            ...
            >
              <Feather name="calendar-outline" size={20} color="#2979FF" />
            ...
            >
              <Feather name="time-outline" size={20} color="#2979FF" />
              <Text style={styles.pickerBtnText}>
