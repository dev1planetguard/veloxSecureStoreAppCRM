...
const pickerStyle = {
 ...
 function MeetingMinutesForm({ navigation: navProp, route }) {
      ...
      <ScrollView contentContainerStyle={styles.container} keyboardShouldPersistTaps="handled">
        <View style={styles.card}>
          ...
          <View style={styles.radioRow}>
            <RadioButton.Android
              value="interested"
              status={customerInterested === "interested" ? "checked" : "unchecked"}
              onPress={() => setCustomerInterested("interested")}
              color="#3b82f6"
              uncheckedColor="#a3aed6"
            />
            <Text style={styles.radioText} onPress={() => setCustomerInterested("interested")}>
              Interested
            </Text>
            <RadioButton.Android
              value="not-interested"
              status={customerInterested === "not-interested" ? "checked" : "unchecked"}
              onPress={() => setCustomerInterested("not-interested")}
              color="#3b82f6"
              uncheckedColor="#a3aed6"
            />
            <Text style={styles.radioText} onPress={() => setCustomerInterested("not-interested")}>
              Not Interested
            </Text>
          </View>
          ...
          {customerInterested === "interested" && (
            <View style={{ marginTop: hp('1%'), backgroundColor: '#151538', padding: wp('3%'), borderRadius: wp('2.5%') }}>
              ...
              <Text style={[styles.label, { marginTop: hp('1.5%') }]}>License Type</Text>
              <RNPickerSelect
          ...
          <TouchableOpacity
            activeOpacity={0.7}
            style={pickerStyle.inputAndroid}
            onPress={() => clientTypePickerRef.current.togglePicker()}
          >
            <RNPickerSelect
